...
const char* GetDescriptorName(U8 descriptor)
{
	switch (descriptor)
	{
	case DT_DEVICE:						return "DEVICE";
	case DT_CONFIGURATION:				return "CONFIGURATION";
	case DT_STRING:						return "STRING";
	case DT_INTERFACE:					return "INTERFACE";
	case DT_ENDPOINT:					return "ENDPOINT";
	case DT_DEVICE_QUALIFIER:			return "DEVICE_QUALIFIER";
	case DT_OTHER_SPEED_CONFIGURATION:	return "OTHER_SPEED_CONFIGURATION";
	case DT_INTERFACE_POWER:			return "INTERFACE_POWER";

	// HID Class specific descriptors
	case DT_HID:				return "HID";
	case DT_HID_REPORT:			return "HID Report Descriptor";
	case DT_HID_PHYS:			return "HID Physical Descriptor";

	// CDC Class specific descriptors
	case DT_CDC_CS_INTERFACE:	return "CS_INTERFACE";
	case DT_CDC_CS_ENDPOINT:	return "CS_ENDPOINT";
	}
...
const char* GetRequestName(U8 request)
{
	...
	case SYNCH_FRAME:		return "SYNCH_FRAME";
	}
...
const char* GetHIDRequestName(U8 request)
{
	switch (request)
	{
	case GET_REPORT:	return "GET_REPORT";
	case GET_IDLE:		return "GET_IDLE";
	case GET_PROTOCOL:	return "GET_PROTOCOL";
	case SET_REPORT:	return "SET_REPORT";
	case SET_IDLE:		return "SET_IDLE";
	case SET_PROTOCOL:	return "SET_PROTOCOL";
	}
...
const char* GetCDCRequestName(U8 request)
{
	switch (request)
	{
	case SEND_ENCAPSULATED_COMMAND:		return "SEND_ENCAPSULATED_COMMAND";
	case GET_ENCAPSULATED_RESPONSE:		return "GET_ENCAPSULATED_RESPONSE";
	case SET_COMM_FEATURE:				return "SET_COMM_FEATURE";
	case GET_COMM_FEATURE:				return "GET_COMM_FEATURE";
	case CLEAR_COMM_FEATURE:			return "CLEAR_COMM_FEATURE";
	case SET_AUX_LINE_STATE:			return "SET_AUX_LINE_STATE";
	case SET_HOOK_STATE:				return "SET_HOOK_STATE";
	case PULSE_SETUP:					return "PULSE_SETUP";
	case SEND_PULSE:					return "SEND_PULSE";
	case SET_PULSE_TIME:				return "SET_PULSE_TIME";
	case RING_AUX_JACK:					return "RING_AUX_JACK";
	case SET_LINE_CODING:				return "SET_LINE_CODING";
	case GET_LINE_CODING:				return "GET_LINE_CODING";
	case SET_CONTROL_LINE_STATE:		return "SET_CONTROL_LINE_STATE";
	case SEND_BREAK:					return "SEND_BREAK";
	case SET_RINGER_PARMS:				return "SET_RINGER_PARMS";
	case GET_RINGER_PARMS:				return "GET_RINGER_PARMS";
	case SET_OPERATION_PARMS:			return "SET_OPERATION_PARMS";
	case GET_OPERATION_PARMS:			return "GET_OPERATION_PARMS";
	case SET_LINE_PARMS:				return "SET_LINE_PARMS";
	case GET_LINE_PARMS:				return "GET_LINE_PARMS";
	case DIAL_DIGITS:					return "DIAL_DIGITS";
	case SET_UNIT_PARAMETER:			return "SET_UNIT_PARAMETER";
	case GET_UNIT_PARAMETER:			return "GET_UNIT_PARAMETER";
	case CLEAR_UNIT_PARAMETER:			return "CLEAR_UNIT_PARAMETER";
	case GET_PROFILE:					return "GET_PROFILE";
	case SET_ETHERNET_MULTICAST_FILTERS:				return "SET_ETHERNET_MULTICAST_FILTERS";
	case SET_ETHERNET_POWER_MANAGEMENT_PATTERN_FILTER:	return "SET_ETHERNET_POWER_MANAGEMENT_PATTERN_FILTER";
	case GET_ETHERNET_POWER_MANAGEMENT_PATTERN_FILTER:	return "GET_ETHERNET_POWER_MANAGEMENT_PATTERN_FILTER";
	case SET_ETHERNET_PACKET_FILTER:	return "SET_ETHERNET_PACKET_FILTER";
	case GET_ETHERNET_STATISTIC:		return "GET_ETHERNET_STATISTIC";
	case SET_ATM_DATA_FORMAT:			return "SET_ATM_DATA_FORMAT";
	case GET_ATM_DEVICE_STATISTICS:		return "GET_ATM_DEVICE_STATISTICS";
	case SET_ATM_DEFAULT_VC:			return "SET_ATM_DEFAULT_VC";
	case GET_ATM_VC_STATISTICS:			return "GET_ATM_VC_STATISTICS";
	}
...
std::string GetHIDUsagePageName(U16 usagePage)
{
	...
	case 0x81:
	case 0x82:
	case 0x83:	return "Monitor page";
	case 0x84:
	case 0x85:
	case 0x86:
	case 0x87:	return "Power page";
